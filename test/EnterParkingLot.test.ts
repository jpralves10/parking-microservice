...
test("Should enter parking lot", async function(){
    ...
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-10-11T10:00:00"));
...
test.skip("Should be closed", async function(){
    ...
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-10-11T23:00:00"));
})
...
test.skip("Should be full", async function(){
    ...
    await enterParkingLot.execute("shopping", "MMM-0001", new Date("2021-10-11T10:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0002", new Date("2021-10-11T10:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0003", new Date("2021-10-11T10:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0004", new Date("2021-10-11T10:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0005", new Date("2021-10-11T10:00:00"));
    await enterParkingLot.execute("shopping", "MMM-0006", new Date("2021-10-11T10:00:00"));
})